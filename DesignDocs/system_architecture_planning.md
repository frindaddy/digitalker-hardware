...
With these considerations in mind, the ideal choice for the MCU is the **RP2354B**. With its dual 150MHz ARM (or RISC-V) cores, 3 150MHz PIO state machines, 32MiB internal QSPI FLASH, and 48 I/O pins, the RP2354B meets all the requirements with pins to spare. It is a widely-used microcontroller with pre-existing libraries for I2S and SPI interfaces. Finally, the RP2354B is *cheap*. At just $1 at the time of writing, its flexibility compared to its cost blows modern CPLDs and FPGAs out of the water.

## I2S Conversion

For audio recording, the PCM1809 will be used. The up to 192kHz sampling rate and 32-bit channel depth meet the audio recording requirements, and the internal PLLs simplify the RP2354B connections to just 3 pins.
